...
- Resource: `/local/ha-electricity-price-card/ha-electricity-price-card.js?v=0.3.0`
...
- Version 0.2.9 fjerner den svage ydre 1 px-ramme og bevarer kun kortets blå venstre accent, radius og skygge.
- Version 0.3.0 synkroniserer liveudgavens temaafledte accentrammer for faner, pile og dagsvalg.
