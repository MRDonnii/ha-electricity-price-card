...
- Resource: `/local/ha-electricity-price-card/ha-electricity-price-card.js?v=0.2.1`
...
- Version 0.2.1 genskaber de oprindelige 62 px fanekort med titel, undertitel, venstre accent, baggrundsikon og AKTIV-badge. Hver forecastdag har desuden sin egen ugedags- og datoknap, valgt dag fremhæves, og grafen skifter direkte. Laveste og højeste søjle har igen synlige prismarkører.
